...
const languages = {
    ...
    'ru': {
        ...
        toggleOrbits: 'Переключать орбиты',
        toggleView: 'Вид сверху вниз',
        toggleSpeed: 'Скорость: нормальная',
        toggleStars: 'Переключать звезды',
        toggleLabels: 'Переключать надписи',
        speedSlow: 'Скорость: медленная',
        speedNormal: 'Скорость: нормальная',
        speedFast: 'Скорость быстрая'
};
